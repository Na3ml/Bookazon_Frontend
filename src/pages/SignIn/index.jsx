...
//         <p className="login-title text-secondary text-center">
//           Log in to your account
//         </p>

//         <Form className="register sign">
//           <Form.Group>
//             <Form.Label>Email</Form.Label>
//             <Form.Control
//               type="email"
...
//           <Button variant="login" className="btn btn-login bg-secondary">
//             Log In
//           </Button>
...
//         <Button className="btn d-flex align-items-center btn-social">
//           <BsFacebook className="social-icon" size={30} />
//           Continue With Facebook
//         </Button>

//         <Button className="btn d-flex align-items-center btn-social">
//           <FcGoogle className="social-icon" size={30} />
//           Continue With Google
//         </Button>
