  ...
  <div className="bg-light py-5">
      ...
      <Row className="feature position-relative">
        ...
        <div className="image pt-3 ps-2">
          ...
          <p className="vertical fw-medium">Our  Amazing Services </p>
        </Col>
        <div className="d-flex align-items-center   flex-wrap  start-0 services ">
          {images.map((item)=>{
            return (   <img src={item} alt={item} className="me-md-5 me-3 mb-md-0 mb-3"/>)
          })
