...
import { HashLink as Link } from "react-router-hash-link";
import {  Container } from "react-bootstrap";
import { AiOutlineMenu, AiOutlineShareAlt } from "react-icons/ai";
import { BsArrowLeft } from "react-icons/bs";
const HotelNavigate = () => {
  ...
  return (
    <>
      <div className="hotel-navigate mb-5">
        {/* <h1 className="hotel-navigate-title">SWITZERLAND HOTEL</h1> */}
        <div className="hotel-navigate-route ">
          <Container className="hotel-navigate-route-container d-flex justify-content-between pt-3 pt-lg-0">
          ...
          <div className="hotel-mobile-btn " onClick={handleChange}>
